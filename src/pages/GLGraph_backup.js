...
class GLGraph extends React.Component{
    ...
    updatecount(){
        if (this.currentFile === undefined)
            ...
            this.count = this.currentFile.sampleRate / 1000 * (this.props.timescale / this.compressionRate);
    }
    ...
    update (){
        this.updatecount();
        this.peakOffset += Math.round((this.currentFile === undefined ? 100 : this.currentFile.sampleRate) * (this.deltaTime * 0.001) * this.props.speed / this.compressionRate);
    ...
    draw (isUpdateGrid){
        ...
        for (c = 0; c < this.currentPeakArray.length; c++){
            ...
            vertices.push((this.currentPeakArray[c][Math.max(this.peakOffset, 0)] * halfHeight) + startY);
